...
import io.mistarpeo.sgboard.config.auth.dto.OAuthAttributes;
import io.mistarpeo.sgboard.config.auth.dto.SessionUser;
import io.mistarpeo.sgboard.domain.user.User;
import io.mistarpeo.sgboard.domain.user.UserRepository;
